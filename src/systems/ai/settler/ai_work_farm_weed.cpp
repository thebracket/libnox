...
namespace systems {
	namespace ai_farm_weed {
		...
		namespace jobs_board {
			void evaluate_farm_weeding(job_board_t &board, entity_t &e, position_t &pos, job_evaluator_base_t *jt) {
		...
		static const char * job_tag = "Farm - Weeding";
		static work::templated_work_steps_t<ai_tag_work_farm_weed> work;

		inline void find_hoe(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
			work::get_tool<item_farming_t, designated_farmer_t, ai_tag_work_farm_weed>(e, work, h, pos,
				[&h]() {
				// On we have it
		...
		inline void fetch_hoe(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
		...
		inline void find_target(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
		...
		inline void fetch_target(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
			work.follow_path(h, pos, e, [&h]() {
				// Cancel
				h.current_path.reset();
				h.step = ai_tag_work_farm_weed::weed_steps::FIND_HOE;
		...
		inline void weed(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
		...
		void dispatch(entity_t &e, ai_tag_work_farm_weed &h, ai_tag_my_turn_t &t, position_t &pos) {
			switch (h.step) {
			case ai_tag_work_farm_weed::weed_steps::FIND_HOE: find_hoe(e, h, t, pos); break;
			case ai_tag_work_farm_weed::weed_steps::FETCH_HOE: fetch_hoe(e, h, t, pos); break;
			case ai_tag_work_farm_weed::weed_steps::FIND_TARGET: find_target(e, h, t, pos); break;
			case ai_tag_work_farm_weed::weed_steps::FETCH_TARGET: fetch_target(e, h, t, pos); break;
			case ai_tag_work_farm_weed::weed_steps::WEED: weed(e, h, t, pos); break;
			}
		}

		void run(const double &duration_ms) {
			work.do_work(jobs_board::evaluate_farm_weeding, dispatch, job_tag);
		}
	}
}
